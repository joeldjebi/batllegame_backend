...
return [
    ...
    'attributes' => [
        ...
        'qualifiers_per_group' => 'qualifiés par poule',
        'discipline' => 'discipline',
        'mode' => 'mode',
        'max_points' => 'note maximale',
        'weight' => 'poids',
        'country_id' => 'pays',
        'participant_id' => 'participant',
        'winner_id' => 'vainqueur',
        'seed' => 'tête de série',
        'rules.group_count' => 'nombre de poules',
        'rules.rounds' => 'nombre de passages',
        'rules.turn_duration' => "durée d'un passage",
        'rules.jury_weight' => 'poids du jury',
        'rules.public_weight' => 'poids du public',
        'group_count' => 'nombre de poules',
        'rounds' => 'nombre de passages',
        'turn_duration' => "durée d'un passage",
        'jury_weight' => 'poids du jury',
        'public_weight' => 'poids du public',
        'voting_closes_at' => 'fin du vote',
        'voting_opens_at' => 'ouverture du vote',
        'settings.max_votes_per_device' => 'votes maximum par appareil',
