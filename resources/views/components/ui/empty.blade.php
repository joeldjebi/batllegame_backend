...
<div {{ $attributes->class('flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 px-6 py-12 text-center dark:border-white/10') }}>
    <span class="grid size-12 place-items-center rounded-2xl bg-gradient-to-br from-brand-50 to-fuchsia-50 text-brand-600 ring-1 ring-brand-100 dark:from-brand-500/10 dark:to-fuchsia-500/10 dark:text-brand-300 dark:ring-brand-400/20">
